...
const char* CQ_ENDPOINT = "kmsstaging.cryptoquantique.com";

// this is the root certfificate of the CQ Security Gateway
const char* CQ_GATEWAY_CERT = \
"-----BEGIN CERTIFICATE-----\n" \
...
CQSecurityGatwayClient cqClient(CQ_ENDPOINT, CQ_GATEWAY_CERT, wiFiClient);
